...
`☘-form-item-message[data-primary]` 可以显示提示消息
...
form#formitems-kanban(onsubmit=function(){console.log(this.elements);return false})
    .☘-form-item
        ...
        .☘-input-wrapper(data-primary)
            ...
            span.☘-form-item-message.error-msg(data-primary="danger") 卡号必填
    .☘-form-item
        label(for="keywords") 类型
        .☘-input-wrapper(data-primary)
            each item in [
            ...
            span.☘-form-item-message.error-msg(data-primary="danger") 类型必填
...
style(lang="stylus").
    #formitems-kanban
        .error-msg
            visibility hidden
        .☘-input-wrapper[data-primary]:has(:focus:invalid)
            --color-input-wrapper var(--danger-6)
            --background-color-selection var(--danger-9)
            --color-selection var(--danger-1)
            .error-msg
                visibility visible
```
