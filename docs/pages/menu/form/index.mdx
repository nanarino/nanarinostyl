...
- `button`
    - <T tag="button" class="☘-button sm">按钮</T>
      支援：<kbd class="na-kbd">Tab</kbd> <kbd class="na-kbd">Enter</kbd>
- `a`
...
- `input`
    ...
    - <Switch id="switch" class="sm" checked />
      支援：<kbd class="na-kbd">Tab</kbd> <kbd class="na-kbd">Space</kbd>
    - <Radio name="lang" id="A" checked>A</Radio> <Radio name="lang" id="B">B</Radio>
      支援：<kbd class="na-kbd">Tab</kbd> <kbd class="na-kbd">&larr;</kbd><kbd class="na-kbd">&rarr;</kbd> <kbd class="na-kbd">&uarr;</kbd><kbd class="na-kbd">&darr;</kbd>
- `textarea`
...
- `select` `option`
    - <T tag="select" class="☘-select" style="width:120px">
      ...
      支援：<kbd class="na-kbd">Tab</kbd> <kbd class="na-kbd">Space</kbd> <kbd class="na-kbd">Enter</kbd> <kbd class="na-kbd">&larr;</kbd><kbd class="na-kbd">&rarr;</kbd> <kbd class="na-kbd">&uarr;</kbd><kbd class="na-kbd">&darr;</kbd>
