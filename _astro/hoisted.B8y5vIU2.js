import{p as a}from"./hoisted.CKkHyN2g.js";document.addEventListener("astro:page-load",()=>{const o=document.getElementById("colors-kanban");o&&(o.onclick=function(s){const e=s.target;e.tagName==="BUTTON"&&e.title&&(window.copy(`rgb(var(${e.title}))`),window.dispatchEvent(new CustomEvent(`${a}-message`,{detail:{content:`
                        <svg
