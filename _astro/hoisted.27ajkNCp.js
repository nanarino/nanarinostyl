import{p as a,d as i}from"./hoisted.L6UPVbuE.js";document.addEventListener("astro:page-load",()=>{const n=document.getElementById("colors-kanban");n&&(n.onclick=function(s){const e=s.target;e.tagName==="BUTTON"&&e.title&&(window.copy(`rgb(var(${e.title}))`),window.dispatchEvent(new CustomEvent(`${a}-message`,{detail:{content:i`
                                <svg
