...
本文档的左侧菜单利用了这个，但是使用的 [_`details>summary`_](https://github.com/nanarino/nanarinostyl/blob/main/src/components/menu/summary.astro)

结合 `details[name]` 属性可以在不写JavaScript的情况下保持只有一个子菜单展开

在之前的实现是 [_`ul>li`_](https://github.com/nanarino/nanarinostyl/blob/main/src/components/menu/list.astro)
